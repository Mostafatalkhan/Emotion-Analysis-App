...
class _FaceViewState extends State<FaceView> {
  ...
  Future<File> _compressImage(File imageFile) async {
    // Read image file and decode to an Image object
    ...
    final img.Image resizedImage = img.copyResize(originalImage, width: 600);  // Adjust width as needed

    // Encode the resized image back to a file
    final List<int> resizedImageBytes = img.encodeJpg(resizedImage, quality: 85);  // Adjust quality as needed
    final String resizedImagePath = '${imageFile.path}_resized.jpg';
    final File resizedImageFile = File(resizedImagePath)..writeAsBytesSync(resizedImageBytes);
